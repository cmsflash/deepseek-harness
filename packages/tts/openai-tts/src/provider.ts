 ...
 * @module @deepseek-ai/dsh-openai-tts/provider
 */

import { SpeechError } from '@deepseek-ai/dsh-tts'
import type { SpeechAudio, SpeechProvider, SpeechSpec } from '@deepseek-ai/dsh-tts'
