...
import TtsRuntime, { type SpeechProvider } from '@deepseek-ai/dsh-tts'
import * as speechRoutesPlugin from '@deepseek-ai/dsh-openai-tts'
import { OPENAI_DEFAULT_BASE_URL, apply, inject, name } from '@deepseek-ai/dsh-openai-tts'
...
describe('openai-tts plugin', () => {
  it('declares its loader identity and the seam it needs', () => {
    expect(name).toBe('openai-tts')
    expect(inject).toEqual(['tts'])
  })
