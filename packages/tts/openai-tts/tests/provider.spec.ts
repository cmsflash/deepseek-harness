...
import { OpenAiTtsProvider } from '@deepseek-ai/dsh-openai-tts'
import type { SpeechSpec } from '@deepseek-ai/dsh-tts'
...
function provider(overrides: Partial<ConstructorParameters<typeof OpenAiTtsProvider>[0]> = {}) {
