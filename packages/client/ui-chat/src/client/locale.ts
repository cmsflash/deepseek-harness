...
export const zh = {
  ...
  'settings.transcript.description': '控制轮次过程内容的显示方式',
  'settings.transcript.normal': '标准',
  'settings.transcript.compact': '紧凑',
  'settings.transcript.collapsed': '折叠步骤',
  'collapse.steps': '{count} 步',
  'collapse.calls': '{count} 次调用',
  'collapse.contextInjection': '{count} 次上下文注入',
  'collapse.contextInjections': '{count} 次上下文注入',
  'collapse.linesAdded': '+{added}',
  'collapse.linesRemoved': '-{removed} 行',
  'collapse.files': '{count} 个文件',
  'collapse.tokens': '{total} tokens（入 {input} / 出 {output}）',
...
export const en = {
  ...
  'settings.transcript.description': 'Controls how turn process content is shown',
  'settings.transcript.normal': 'Normal',
  'settings.transcript.compact': 'Compact',
  'settings.transcript.collapsed': 'Collapsed steps',
  'collapse.steps': '{count} steps',
  'collapse.calls': '{count} calls',
  'collapse.contextInjection': '{count} context injection',
  'collapse.contextInjections': '{count} context injections',
  'collapse.linesAdded': '+{added}',
  'collapse.linesRemoved': '-{removed} lines',
  'collapse.files': '{count} files',
  'collapse.tokens': '{total} tokens ({input} in / {output} out)',
