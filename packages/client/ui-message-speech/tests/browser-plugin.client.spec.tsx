...
/**
 * ui-message-speech browser half on a real cordis Context with fake
...
async function bench(audioOk = true) {
  ...
  ctx.provide('remote.speechCache', speechCache)
...
describe('ui-message-speech browser plugin', () => {
  ...
  it('has an empty node half and a registering invariant companion', async () => {
    ...
    expect(registered).toEqual(['@deepseek-ai/dsh-client-ui-message-speech'])
  })
})
