/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-client-ui-message-speech`.
 * @module @deepseek-ai/dsh-client-ui-message-speech/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-client-ui-message-speech'
