...
describe('markdown table copy control', () => {
  ...
  it('restores the idle label after the confirmation window', async () => {
    ...
    render(<MarkdownText text={TABLE} codeLabels={{ copyLabel: 'Copy table', copiedLabel: 'Copied' }} />)
