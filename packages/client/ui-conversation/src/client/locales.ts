...
export const zh = {
  ...
  'settings.collapse.title': '折叠已完成的中间步骤',
  'settings.collapse.description': '每轮只展开最后一步；更早的步骤收进一行摘要，点击可展开',
...
export const en = {
  ...
  'settings.collapse.title': 'Collapse settled intermediate steps',
  'settings.collapse.description': 'Keep only each turn\'s last step expanded; earlier steps fold into one summary row you can open',
