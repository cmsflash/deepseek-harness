...
export const zh = {
  ...
  'history.loadingStepDetail': '正在加载完整步骤详情…',
  'history.stepDetailError': '完整步骤详情加载失败：{message}（{code}）',
  'history.retryStepDetail': '重试',
...
export const en: Record<TrajectoryKey, string> = {
  ...
  'history.loadingStepDetail': 'Loading full step detail…',
  'history.stepDetailError': 'Failed to load full step detail: {message} ({code})',
  'history.retryStepDetail': 'Retry',
