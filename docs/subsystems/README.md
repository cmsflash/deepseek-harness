...
| [tts.md](tts.md) | the text-to-speech seam: `SpeechRequest`/`Spec`/`Audio`, `SpeechProvider`, execution-time selection, and why audio is a cache rather than session state |
