...
| [speech.md](speech.md) | the speech synthesis seam: `SpeechRequest`/`Spec`/`Audio`, `SpeechProvider`, execution-time selection, and why audio is a cache rather than session state |
