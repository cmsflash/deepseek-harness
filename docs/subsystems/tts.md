...
The `readAloud` Remote addresses audio by identity, never by prose: a browser sends the session and message, and the host recovers the spoken text from its own log.
