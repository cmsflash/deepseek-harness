...
| `ctx.speech` | `seam` | [`speech`](../packages/speech/speech) | [`speech-litellm`](../packages/speech/speech-litellm) | [`speech-cache`](../packages/speech/speech-cache) | - | Providers register into one ctx.speech seam; the seam resolves deployment policy into a spec before any provider runs. |
