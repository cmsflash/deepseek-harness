...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-focus': { kind: 'none', reason: 'Browser-side conversation view folding already-logged nodes into per-turn figures; registers nothing model-facing.' },
